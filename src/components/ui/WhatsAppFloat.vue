  ...
  <div class="fixed bottom-6 right-6 z-50">
    ...
    <div class="relative">
      ...
      <a
        ...
        class="group relative flex items-center justify-center w-16 h-16 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-xl hover:shadow-2xl transform transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-green-300"
      ...
      >
        ...
        <!-- WhatsApp Icon -->
        <svg class="relative z-10 w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
